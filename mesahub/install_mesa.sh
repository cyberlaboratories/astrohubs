...
echo "to the version specified below. This is"
echo "intended to be convenient for users who just"
echo "want to quickly do a test run and move on."
echo "If you end up using MESA on astrohub for a"
echo "longer project you should make sure you"
echo "avoid having this link overwritten, for"
echo "example by creating your own link manually"
